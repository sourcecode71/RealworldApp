...
namespace Persistance.Migrations
{
    ...
    [Migration("20220403155440_wrkUP3")]
    partial class wrkUP3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Projects.HisBudgetActivities", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("BudgetFor")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("OriginalBudget")
                        .HasColumnType("float");

                    b.Property<DateTime>("OriginalSetDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Projects.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Projects.WorkOrder", b =>
                {
                    ...
                    b.Property<DateTime>("BudgetUpdateDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Projects.WorkOrderActivities", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Projects.WorkOrderEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("OriginalBHours")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Domain.Projects.Payment", b =>
                {
                    b.HasOne("Domain.Projects.Invoice", "Invoice")
                        .WithMany()
